...
export const VENUE_TYPE_FILTERS: Array<IVenueTypeFilter> = [
  {
    ...
    on: false,
    foursquareCategory: collectCategories(restaurantCafeCategories),
  },
  {
    id: "grocery",
    name: "Market / Store",
    on: false,
    foursquareCategory: collectCategories(marketGroceryCategories),
  },
  {
    id: "coffeeShop",
    name: "Coffee Shop",
  ...
  },
  {
    ...
    name: "Juice Bar",
    on: false,
    foursquareCategory: collectCategories(juiceBarCategories),
  },
  {
    id: "healthFoodStore",
    name: "Health Food Store",
    on: false,
    foursquareCategory: collectCategories(healthFoodStoreCategories),
  },
];
