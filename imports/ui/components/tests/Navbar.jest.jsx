...
describe("<Navbar />", function () {
  ...
  it("when user logged in should show username", function () {
    const wrapper = shallow(<Navbar userLoggedIn username="testuser" logout={jest.fn()} />);
    expect(wrapper.find(es.navbar.username).prop("children")).toEqual("Welcome, testuser!");
  });
