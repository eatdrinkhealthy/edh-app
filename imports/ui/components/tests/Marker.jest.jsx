...
describe("<Marker />", function() {
  ...
  it("matches render snapshot, unselected", function() {
    const tree = renderer
      .create(<Marker venue={testVenue} setSelectedVenueHandler={stubFn} />, options)
      .toJSON();
  ...
  it("matches render snapshot, selected", function() {
    const tree = renderer
      .create(
        <Marker venue={testVenue} selected setSelectedVenueHandler={stubFn} />,
        options,
      )
      .toJSON();
    expect(tree).toMatchSnapshot();
  ...
  it("should have default style and origin classes", function() {
    const wrapper = shallow(
      <Marker venue={testVenue} setSelectedVenueHandler={stubFn} />,
    );
