    ...
    describe("CreateAccount", function() {
      ...
      describe("client side call of Accounts.createUser", function() {
        describe("user schema validation", function() {
          ...
          it("should NOT return an error when all user fields match schema", function(done: () => void) {
            const validUser = {
              username: "abcd",
              email: "abcd@test.com",
              password: "1234567",
          ...
          it("should return a ValidationError when username not provided", function(done: () => void) {
            const invalidUser = {
              username: "", // too short
              email: "abc@test.com",
              password: "StrongPassword",
          ...
          it("should return a ValidationError when email not provided", function(done: () => void) {
            const invalidUser = {
              username: "abcd",
              email: "",
              password: "StrongPassword",
          ...
          it("should return a ValidationError when email doesn't match regex", function(done: () => void) {
            const invalidUser = {
              username: "abcd",
              email: "test",
              password: "StrongPassword",
          ...
          it("should return a ValidationError when username matches 'root', case insensitive", function(done: () => void) {
            const invalidUser = {
              username: "rOot",
              email: "rOot@test.com",
              password: "StrongPassword",
          ...
          it("should return a ValidationError when username matches 'admin', case insensitive", function(done: () => void) {
            const invalidUser = {
              username: "adMin",
        ...
        describe("special characters in password", function() {
          ...
          it("should create user with password that has special characters", function(done: () => void) {
          ...
          it("should allow login with a password that has special characters", function(done: () => void) {
            Meteor.loginWithPassword(
              userWithStrangePw.username,
              userWithStrangePw.password,
              function() {
                const user = Meteor.user();
                const username = user && user.username;
        ...
        describe("duplicate user prevention", function() {
          ...
          it("should create a user to be used for comparing duplicates", function(done: () => void) {
          ...
          it("should deny creating a user, where a user with same a username AND email already exist", function(done: () => void) {
            const dupUser = {
              username: "orig",
              email: "orig@test.com",
              password: "StrongPassword",
          ...
          it("should deny creating a user with username that already exists", function(done: () => void) {
            const dupUser = {
              username: "orig",
          ...
          it("should deny creating a user with email that already exists", function(done: () => void) {
            const dupUser = {
              username: "different",
              email: "orig@test.com",
              password: "StrongPassword",
          ...
          it("should deny creating a user for username that already exists, case insensitive", function(done: () => void) {
            const dupUser = {
              username: "oRig",
              email: "different@test.com",
              password: "StrongPassword",
          ...
          it("should deny creating a user with email that already exists, case insensitive", function(done: () => void) {
            const dupUser = {
              username: "different",
              email: "orIg@test.com",
              password: "StrongPassword",
        ...
        describe("deny writes to user document", function() {
          ...
          it("should create a user for deny write testing", function(done: () => void) {
