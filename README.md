...
> NOTE: A test / staging version of this application can be found on <a href="https://edh-app-staging.herokuapp.com/" target="_blank">Heroku</a>. The browser must be given access to location (and sometimes reloaded) to be able to center the map based on current location.
